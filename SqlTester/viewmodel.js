...
define([
	...
	function runTest() {
		...
		integration.all(integrationName).then(
			function (data) {
				...
				logBox(
					"\u2551           SQL INTEGRATION RESULTS - DETAILED ANALYSIS             \u2551",
				);
				logBox(
					"\u255A\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u255D",
				);
				...
				logSuccess(
					'Total Records Returned: <span class="record-count">' +
						data.length +
						"</span>",
				);
				log("");
				...
				logSuccess(
					'Total Columns/Fields: <span class="record-count">' +
						columns.length +
						"</span>",
				);
				log("");
				...
				log(
					'Total records: <span class="record-count">' +
						data.length +
						"</span>",
				);
				log(
					'Total columns: <span class="record-count">' +
						columns.length +
						"</span>",
				);
				log("");
				...
				log("");
				logSuccess(
					'Analysis complete - Use "Copy All" to export results',
				);
