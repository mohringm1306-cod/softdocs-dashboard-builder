...
function generateFormsSQL() {
    ...
    var cte = ';' + _Q.WT + ' LatestInput ' + _Q.AS + ' (\n' +
        '   ' + _Q.SL + ' iv.FormID, iv.InputID, iv.Value,\n' +
        '      ' + _Q.RN + '() ' + _Q.OV + ' (' + _Q.PB + ' iv.FormID, iv.InputID ' + _Q.OB + ' iv.TimeStamp ' + _Q.DS + ') ' + _Q.AS + ' rn\n' +
        '   ' + _Q.FR + ' reporting.central_forms_InputValue iv\n' +
        '   ' + _Q.IJ + ' reporting.central_forms_Form f2 ' + _Q.ON + ' f2.FormID = iv.FormID\n' +
        '   ' + _Q.WH + ' f2.TemplateVersionID = ' + verFilter + ' ' + _Q.AN + ' f2.IsDraft = 0\n' +
        '),\n' +
        'LatestPackage ' + _Q.AS + ' (\n' +
        '   ' + _Q.SL + ' pd.SourceID, pd.PackageID,\n' +
        '      ' + _Q.RN + '() ' + _Q.OV + ' (' + _Q.PB + ' pd.SourceID ' + _Q.OB + ' pd.PackageID ' + _Q.DS + ') ' + _Q.AS + ' rn\n' +
        '   ' + _Q.FR + ' reporting.central_flow_PackageDocument pd\n' +
        '),\n' +
        'ActiveTask ' + _Q.AS + ' (\n' +
        '   ' + _Q.SL + ' tq.*,\n' +
    ...
    sql += '\n' + _Q.FR + ' reporting.central_forms_Form f\n' +
        ...
        '   ' + _Q.ON + ' f.FormID = iv.FormID ' + _Q.AN + ' iv.rn = 1\n' +
        _Q.LJ + ' LatestPackage pd\n' +
        '   ' + _Q.ON + ' pd.SourceID = ' + _Q.CT + '(f.FormID ' + _Q.AS + ' ' + _Q.VC + '(50)) ' + _Q.AN + ' pd.rn = 1';
    ...
    sql += '\n' + _Q.LJ + ' ActiveTask tq\n' +
        '   ' + _Q.ON + ' tq.PackageId = pd.PackageID ' + _Q.AN + ' tq.rn = 1\n' +
    ...
    sql += '\n' + _Q.WH + ' f.TemplateVersionID = ' + verFilter + '\n' +
        '   ' + _Q.AN + ' f.IsDraft = 0\n' +
...
function downloadDashboard() {
    ...
    if (typeof saveDashboardToLibrary === 'function') { try { saveDashboardToLibrary(true); } catch (e) {} }
...
function generateColumnDefinitions() {
    ...
    if (State.mode === 'content') {
        ...
        columns.push("        { field: 'SubmittedDate', label: 'Submitted', type: 'date' }");
        ...
        if (State.selectedInputIds.includes('__assignedTo__') && State.styleConfig && State.styleConfig.assigneeColumnName) {
